...
class result:
    ...
    def __init__(self,master):
        ...
        self.frame = Frame(master,width=W,height= H,bg="#246583")
        self.frame1=Frame(self.frame,width=W, height = H/8,bg='#246583')
        self.frame2=Frame(self.frame,width=W-100, height = 7*H/8,bg='#FFFFFF')
        f21H = (4*H/16)
        f21W = (W/4)
        ...
        self.frame2.place(x=20,y=H/8)
        self.frame21.place(x=W/2-W/8,y=10)
        ...
        self.choice = {'Computer Science & Engineering':0,'Electrical Engineering':1,'Electronics & Communication Engineering':2,'Civil Engineering':3,'Chemical Engineering':4,'Mechanical Engineering':5,'Information & Technology':6}
        ...
        #myimg = ImageTk.PhotoImage(file="banner.jpg")
        #self.L = Label(self.frame1,image=myimg).place(x=0,y=0)
    def Submit(self):
